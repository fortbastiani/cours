...
\begin{exemplebox}
    ...
    \hl[RougeClair]{\bb{Interprétation}}: Si tous les enfants avaient
...
\begin{exemplebox}
    ...
    $$\answer{\dfrac{18 + 12 + 15 + 14 + 20 + 17}{6} = \dfrac{96}{6} = 16}$$


    \hl[RougeClair]{\bb{Interprétation}}: Si toutes les notes étaient
...
\begin{exercicebox}
    ...
    \begin{itemize}
        \item 14; 6; 7 : $\answer{\dfrac{14+6+7}{3}= \dfrac{27}{3} = 9}$
        \item 15; 20; 18; 22; 25 : $\answer{\dfrac{15 + 20 + 18 + 22 + 25}{5}=
            \dfrac{100}{20} = 5}  $
        \item 140; 170; 160; 130 : $\answer{\dfrac{140 + 170 + 160 + 130}{4} =
            \dfrac{600}{4} = 150}$
    \end{itemize}
\end{exercicebox}
